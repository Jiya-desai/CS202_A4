...
while (Tanks.Count > 0)
{
	...
	if (Console.KeyAvailable)
	{
		...
		{
			case ConsoleKey.UpArrow: Player.Direction = Direction.Up; Player.IsShooting = false; break;
			case ConsoleKey.DownArrow: Player.Direction = Direction.Down; Player.IsShooting = false; break;
			case ConsoleKey.LeftArrow: Player.Direction = Direction.Left; Player.IsShooting = false; break;
			case ConsoleKey.RightArrow: Player.Direction = Direction.Right; Player.IsShooting = false; break;
			case ConsoleKey.Spacebar: Player.IsShooting = true; break;
			case ConsoleKey.Escape:
				Console.Clear();
				Console.WriteLine("Tanks was closed.");
				return;
		}
	}
	...
	foreach (var tank in Tanks)
	{
		...
		if (tank.IsPlayer)
		{
			#region Player Controled

			Direction? move = null;
			switch (tank.Direction)
			{
				case Direction.Up: move = Direction.Up; break;
				case Direction.Down: move = Direction.Down; break;
				case Direction.Left: move = Direction.Left; break;
				case Direction.Right: move = Direction.Right; break;
			}
...
void Render(string @string, bool preserveCursorPosition = false)
{
